  ...
  <main class="smart-main">
   <img class="logo" src="/HF21/image/logo.svg" alt="ロゴ" />
    ...
    <form class="form1" method="post" action="/HF21/servlet/login">
      <input id="user" class="un " type="text" align="center" placeholder="ユーザーID" value="<%= userID_temp %>" required>
      <input id="password" class="pass" type="password" align="center" placeholder="パスワード" required><br>
