    ...
    <div class="container">
        <div class="chat-box" id="chatBox">
            ...
            <div class="message right">
            	<table class= "flex_r">
            		<tr>
            			...
            			<td id="icon"><div class="picture"><img id="imgicon" src="image/kudou.png" alt="menu-icon" class="hdrprfile"></div></td>
            		</tr>
                </table>
            </div>
            <%
            ...
            <div class="message left">
            	<table class= "flex_l">
            		<tr>
            			<td id="icon"><div class="picture"><img id="imgicon" class="maru" src="image/megane.jpg" alt="picture"></div></td>
            			<td id="msg"><p class="lp"><%=text %></p></td>
