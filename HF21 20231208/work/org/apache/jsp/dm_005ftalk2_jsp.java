 ...
 * Generated at: 2023-12-08 01:02:48 UTC
...
public final class dm_005ftalk2_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 response.setContentType("text/html; charset=UTF-8"); 
    ...
    try {
      ...
      out.write("    var messageInput = document.getElementById(\"text\");\r\n");
      out.write("    var messageText = messageInput.value.trim();\r\n");
      out.write("    if (messageText !== \"\") {\r\n");
      out.write("        var currentTime = new Date();\r\n");
      out.write("        var formattedTime = currentTime.getHours() + \":\" + padZero(currentTime.getMinutes());\r\n");
      out.write("\r\n");
      out.write("        // Append the new message to the chat box\r\n");
      out.write("        appendMessage(\"自分\", messageText, formattedTime);\r\n");
      out.write("\r\n");
      out.write("        // Scroll the chat box to the top\r\n");
      out.write("        scrollChatToTop();\r\n");
      out.write("\r\n");
      out.write("        // Clear the input field\r\n");
      out.write("        messageInput.value = \"\";\r\n");
      out.write("    }\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function appendMessage(sender, text, time) {\r\n");
      out.write("    var chatBox = document.getElementById(\"chatBox\");\r\n");
      out.write("    var messageContainer = document.createElement(\"div\");\r\n");
      out.write("    messageContainer.className = \"message\";\r\n");
      out.write("\r\n");
      out.write("    if (sender === \"自分\") {\r\n");
      out.write("        messageContainer.classList.add(\"right\");\r\n");
      out.write("    } else {\r\n");
      out.write("        messageContainer.classList.add(\"left\");\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    var timeElement = document.createElement(\"span\");\r\n");
      out.write("    timeElement.className = \"time\";\r\n");
      out.write("    timeElement.textContent = time;\r\n");
      out.write("\r\n");
      out.write("    var message = document.createElement(\"p\");\r\n");
      out.write("    message.textContent = text + \": \" + sender;\r\n");
      out.write("\r\n");
      out.write("    messageContainer.appendChild(timeElement);\r\n");
      out.write("    messageContainer.appendChild(message);\r\n");
      out.write("    chatBox.appendChild(messageContainer);\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function scrollChatToTop() {\r\n");
      out.write("    var chatBox = document.getElementById(\"chatBox\");\r\n");
      out.write("    chatBox.scrollTop = chatBox.scrollHeight;\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function padZero(number) {\r\n");
      out.write("    return (number < 10 ? \"0\" : \"\") + number;\r\n");
      out.write("}\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
      out.write("</html>");
